...
export default function Card({ href, frontmatter, secHeading = true }: Props) {
  ...
  return (
    <li className="my-6">
      <a
        href={href}
        className="inline-block text-base font-bold text-skin-accent decoration-dashed underline-offset-4 focus-visible:no-underline focus-visible:underline-offset-0"
      >
        {secHeading ? (
